  ...
  const handleSave = async () => {
    if (editingId === "") {
      try {
        ...
        GetProducts();
        toast.success("Mahsulot muvaffiqiyatli qo'shildi!");
      } catch (error) {
        console.log(error);
      }
    } else {
      try {
        ...
        GetProducts();
        toast.success("Mahsulot muvaffiqiyatli yangilandi!");
      } catch (error) {
        console.log(error);
      }
    }
          ...
          <div className="relative  cursor-pointer  w-full max-w-[18rem] overflow-hidden rounded-lg bg-white shadow-md dark:shadow-[0px_0px_1px_1px_rgb(255,255,255)]">
            ...
            <div className="p-3 rounded-b-lg dark:bg-[#001e36] dark:text-white overflow-hidden">
              ...
              <div className=" flex items-center ">
                <p className="line-clamp-3 ">{pro.description}</p>
              </div>
